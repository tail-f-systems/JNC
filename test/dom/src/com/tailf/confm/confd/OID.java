...
/**
 * This class implements the "confd:oid" datatype from the
 * 'http://tail-f.com/ns/confd/1.0' namespace.
 * 
 * Represents a list of dot-separated integers. For example: 1.1.2.3.169.22142
 * 
 */
public class OID implements Serializable {
    ...
    public OID(java.lang.String v) throws ConfMException {
        value = parseValue(v);
        check();
    }
     ...
     * Parse integer list
     */
    private int[] parseValue(java.lang.String s) throws ConfMException {
