...
/**
 * This class implements the "confd:size" datatype from the
 * 'http://tail-f.com/ns/confd/1.0' namespace.
 * <p>
 * A value that represents a number of bytes. An example could be S1G8M7K956B;
 * meaning 1GB+8MB+7KB+956B = 1082138556 bytes. The value must start with an S.
 * Any byte magnifier can be left out, i.e. S1K1B equals 1025 bytes. The order
 * is significant though, i.e. S1B56G is not a valid byte size. The size value
 * space is as for xs:unsignedLong.
 * 
 */
