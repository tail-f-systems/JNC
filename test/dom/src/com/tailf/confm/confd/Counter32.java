...
/**
 * This class implements the "confd:Counter32 datatype from the
 * 'http://tail-f.com/ns/confd/1.0' namespace.
 * <p>
 * A Counter32 is a synonym for "xs:unsignedInt". Represents an unsigned 32-bit
 * integer. They are inherited from the SNMP world for flexibility in modelling.
 * 
 */
public class Counter32 extends com.tailf.confm.xs.UnsignedInt implements
        Serializable {
