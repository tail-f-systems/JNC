...
/**
 * This class implements the "ipv4Prefix" datatype from the
 * 'http://tail-f.com/ns/confd/1.0' namespace.
 * <p>
 * The ipv4Prefix type represents an IPv4 address prefix. The prefix length is
 ...
 * to 0.
 * <p>
 * The IPv4 address represented in dotted quad notation should have all bits
 * that do not belong to the prefix set to zero.
 * <p>
...
public class Ipv4Prefix implements Serializable {
    ...
    public Ipv4Prefix(String s) throws ConfMException {
        ...
        try {
            ...
            ipaddr = new InetAddressIPv4(v.substring(0, slashAt));
    ...
    public Ipv4Prefix(InetAddressIPv4 ipaddr, int masklen)
    ...
    public void setValue(InetAddressIPv4 ipaddr, int masklen)
            throws ConfMException {
        this.ipaddr = ipaddr;
        this.masklen = masklen;
        check();
