...
/**
 * This class implements the "inetAddress" datatype from the
 * 'http://tail-f.com/ns/confd/1.0' namespace.
 * <p>
 * A value that represents a valid generic Internet address. Values which adhere
...
public class InetAddress implements Serializable {
    ...
    public void setValue(Object v) throws ConfMException {
        if (v instanceof InetAddressIPv4)
            ...
            value = v;
        else if (v instanceof InetAddressDNS)
            value = v;
        else
