...
/**
 * This class implements the "inetAddressIP" datatype from the
 * 'http://tail-f.com/ns/confd/1.0' namespace.
 * <p>
 * A value that represents a valid IPv4 or IPv6 network address. Values which
 * adhere to this type must be one of these types:
 * <ul>
 * <li>inetAddressIPv4
 * <li>inetAddressIPv6
 * </ul>
...
public class InetAddressIP implements Serializable {
    ...
    public void setValue(Object v) throws ConfMException {
        if (v instanceof InetAddressIPv4)
            value = v;
        else if (v instanceof InetAddressIPv6)
            value = v;
        else
