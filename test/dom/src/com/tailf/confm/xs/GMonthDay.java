...
/**
 * This class implements the "xs:gMonthDay" datatype from the
...
public class GMonthDay implements Serializable {
    ...
    /**
     * Constructor for "xs:gDay" from a String in the format "--MM-DD". For
     * example: "--12-01", "--01-01+02:00", "--01-12Z"
     * 
     */
    ...
    public java.lang.String toString() {
        ...
        s = s + "--" + Date.two_digits(month) + "-" + Date.two_digits(day);
        if (timezoned)
    ...
    /**
     * Checks if the value space of two GMonthDay objects are equal.
     */
