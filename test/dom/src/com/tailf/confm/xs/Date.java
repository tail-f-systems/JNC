...
/**
 * This class implements the "xs:date" datatype from the
...
public class Date implements Serializable {
    ...
    public java.lang.String toString() {
        ...
        if (neg)
            s = s + "-";
        s = four_digits(year) + "-" + two_digits(month) + "-" + two_digits(day);
        if (timezoned)
    ...
    /**
     * Checks if the value space of two Date objects are equal.
     */
    ...
    /**
     * ---------- package private static stuff ---------- Used from many of the
    ...
    static java.lang.String timezone_toString(boolean tz_neg, int tz_hh,
            int tz_mm) {
        java.lang.String tz = "";
        if (tz_hh == 0 && tz_mm == 0) {
            tz = "Z";
