...
/**
 * This class implements the "xs:time" datatype from the
...
public class Time implements Serializable {
    ...
    /**
     * Constructor for xs:time from a String in the format "hh:mm:ss". For
     * example: "21:32:52", "21:32:52+02:00", "21:32:52Z", "21:32:52.12679",
     * 
     */
    ...
    public java.lang.String toString() {
        ...
        s = Date.two_digits(hour) + ":" + Date.two_digits(min) + ":"
                + Date.two_digits(secs);
        if (secs_fraction > 0 && secs_fraction_digits > 0) {
            java.lang.String fr = new java.lang.Integer(secs_fraction)
                    .toString();
    ...
    /**
     * Checks if the value space of two Time objects are equal.
     */
