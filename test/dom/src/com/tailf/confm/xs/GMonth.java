...
/**
 * This class implements the "xs:gMonth" datatype from the
 * 'http://www.w3.org/2001/XMLSchema' namespace.
 * 
 * This is recurring month in time.
 * 
 * 
 */
public class GMonth implements Serializable {
    ...
    /**
     * Constructor for "xs:gMonth" from a String in the format "--MM". For
     * example: "--12", "--01+02:00", "--01Z"
     * 
     */
    ...
    /**
     * Checks if the value space of two GMonth objects are equal.
     */
    public boolean equals(GMonth value) {
    ...
    public boolean equals(Object value) {
        if (value instanceof GMonth)
            return ((GMonth) value).equals(this);
        return false;
    }
     ...
     *
     */
    public int compareTo(GMonth value) {
    ...
    private void parseValue(java.lang.String value) throws ConfMException {
        ...
        try {
            ...
            month = month * 10 + Date.parseDigit(b[i++]);
            timezoned = false;
            tz_neg = false;
            tz_hh = 0;
            tz_mm = 0;
     ...
     */
    protected void minInclusive(GMonth restriction) throws ConfMException {
     ...
     */
    protected void minExclusive(GMonth restriction) throws ConfMException {
        throwException(compareTo(restriction) <= 0);
    }
     ...
     */
    protected void maxInclusive(GMonth restriction) throws ConfMException {
        throwException(compareTo(restriction) > 0);
    }
     ...
     */
    protected void maxExclusive(GMonth restriction) throws ConfMException {
        throwException(compareTo(restriction) >= 0);
    }
