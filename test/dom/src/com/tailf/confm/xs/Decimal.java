...
/**
 * This class implements the "xs:decimal" datatype from the
...
public class Decimal implements Serializable {
    ...
    /**
     * count xs:fractionDigits uses the lexical value representation
     */
    ...
    /**
     * count xs:totalDigits uses the lexical value representation
     */
