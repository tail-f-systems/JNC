...
/**
 * This class implements the "xs:language" datatype from the
...
public class Language extends Token implements Serializable {
     ...
     * From RFC 1766:
     * 
     * The syntax of this tag in RFC-822 EBNF is: Language-Tag = Primary-tag *(
     * "-" Subtag ) Primary-tag = 1*8ALPHA Subtag = 1*8ALPHA
     * 
     */
