...
/**
 * This class implements the "xs:duration" datatype from the
...
public class Duration implements Serializable {
    ...
    public boolean equals(Duration value) {
        if (this.negative == value.negative && this.years == value.years
                && this.months == value.months && this.days == value.days
                && this.hours == value.hours && this.mins == value.mins
