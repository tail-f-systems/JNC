...
/**
 * This class implements the "xs:unsignedLong" datatype from the
 * 'http://www.w3.org/2001/XMLSchema' namespace.
 * 
 * Since unsigned 64 bit integers are not possible to represent in Java, a
 * BigInteger is used.
 */
...
public class UnsignedLong implements Serializable {
    ...
    public boolean equals(long value) {
        return (this.value.compareTo(new BigInteger(value + "")) == 0);
    }
    ...
    protected void minInclusive(java.lang.String restriction)
        ...
        throwException(this.value.compareTo(new BigInteger(restriction)) < 0);
    }
