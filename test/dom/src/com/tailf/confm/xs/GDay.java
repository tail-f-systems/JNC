...
/**
 * This class implements the "xs:gDay" datatype from the
 * 'http://www.w3.org/2001/XMLSchema' namespace.
 * 
 * This is recurring day in time.
 * 
 * 
 */
public class GDay implements Serializable {
    ...
    /**
     * Constructor for "xs:gDay" from a String in the format "---DD". For
     * example: "---20", "---01+02:00", "---01Z"
     * 
     */
    ...
    /**
     * Checks if the value space of two GDay objects are equal.
     */
    public boolean equals(GDay value) {
    ...
    public boolean equals(Object value) {
        if (value instanceof GDay)
            return ((GDay) value).equals(this);
        return false;
    }
     ...
     *
     */
    public int compareTo(GDay value) {
     ...
     */
    protected void minInclusive(GDay restriction) throws ConfMException {
     ...
     */
    protected void minExclusive(GDay restriction) throws ConfMException {
        throwException(compareTo(restriction) <= 0);
    }
     ...
     */
    protected void maxInclusive(GDay restriction) throws ConfMException {
        throwException(compareTo(restriction) > 0);
    }
     ...
     */
    protected void maxExclusive(GDay restriction) throws ConfMException {
        throwException(compareTo(restriction) >= 0);
    }
