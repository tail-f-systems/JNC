...
public abstract class Bits extends Int<BigInteger> {
     ...
     */
    public Bits(String value, String mask) throws YangException {
     ...
     * @throws YangException If value does not match mask.
     */
    public Bits(BigInteger value, BigInteger mask) throws YangException {
        super(value);
        check(mask);
    }
    ...
    /*
     * (non-Javadoc)
     * @see com.tailf.netconfmanager.yang.YangInt#valid(java.lang.Number)
     */
    @Override
