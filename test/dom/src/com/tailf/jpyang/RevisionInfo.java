...
public class RevisionInfo {
     ...
     * sends us data where we don't understand the data because the device has a
     * newer revision of the YANG model than we have, we accept that data
     ...
     * produced by a "confdc --merge-revisions ... " command. If this feature is
     * enabled, we can safely talk NETCONF to devices that have an older
