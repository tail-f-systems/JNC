...
<confspec xmlns="http://tail-f.com/ns/confspec/1.0"
  ...
  <elem name="card" minOccurs="0" maxOccurs="unbounded">
    ...
    <!-- power supply -->
    <elem name="powerSupply" minOccurs="0" maxOccurs="unbounded" config="false" generatedName="cardPowerSupply">
    ...
    <elem name="ethernet">
      ...
      <!-- nic -->
      <elem name="nic" minOccurs="0" maxOccurs="unbounded">
        <elem name="slot" keyref="/card/slot" key="true"/>
        <elem name="subSlot" type="subSlotType" key="true"/>
      </elem>
  
      <!-- port -->
      <elem name="port" minOccurs="0" maxOccurs="unbounded">
        <elem name="slot" keyref="../../nic/slot" key="true"/>
        <elem name="subSlot" keyref="../../nic/subSlot" key="true"/>
        <elem name="port" type="xs:unsignedShort" key="true"/>
        <elem name="adminState" type="adminOperType" default="up"/>
      </elem>
  
      <!-- lag -->
      <elem name="lag" minOccurs="0" maxOccurs="unbounded">
        <elem name="name" type="nameType" key="true"/>
      </elem>
  
  </elem>       <!-- end of ethernet -->
</confspec>
