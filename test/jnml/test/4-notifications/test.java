...
public class test {
	...
	TestCase[] tests = new TestCase[] {
		...
		public void test() throws Exception {		
		    ...
		    print("got streams:"+ reply.toXMLString());	
		    sess.closeSession();     
		}
	    },
		...
		public void test() throws Exception {
		    ...
		    print(" url-schemes: ");
		    String[] urlSchemes = sess.getCapabilities().urlSchemes();
		...
		public void test() throws Exception {
			...
			for (int i=0; i<1000; i++) {
			    hosts.createPath(Element.CREATE_NEW,"host[name='"+(i+1000*j)+"', enabled='true', numberOfServers=0]");
			}
		    }
