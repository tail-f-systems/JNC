...
public class test {
	...
	TestCase[] tests = new TestCase[] {
		...
		public void test() throws Exception {
		    ...
		    Element filter = Element.create("http://tail-f.com/ns/simple/1.0","/hosts");
		...
		public void test() throws Exception {
		    /* TCP */	
		    TCPSession tr = new TCPSession("127.0.0.1", 2023, "admin", "501","501", "", "/Users/ola", "");
		    NetconfSession sess= new NetconfSession( tr );       
		    ...
		    print("deleting vega");
		    Element del_vega= Element.create("http://tail-f.com/ns/simple/1.0","hosts/host[name='vega@tail-f.com']");
		    del_vega.markDelete();
		...
		// public boolean skip() { return true; }
		public void test() throws Exception {
		    TCPSession tr1 = new TCPSession("127.0.0.1", 2023, "admin", "501","501", "", "/Users/ola", "");
		    tr1.addSubscriber(new DefaultIOSubscriber("miffo"));
		    NetconfSession sess1= new NetconfSession( tr1 );
		    TCPSession tr2 = new TCPSession("127.0.0.1", 2023, "admin", "501","501", "", "/Users/ola", "");
		    tr2.addSubscriber(new DefaultIOSubscriber("miffo"));
		    NetconfSession sess2= new NetconfSession( tr2 );
		...
		public void test() throws Exception {		
		    ...
		    NetconfSession sess= new NetconfSession( tr );
		    // getConfig
		    Element subtreeFilter = Element.create("http://tail-f.com/ns/simple_strange/1.0","/strange_host");
		    try {
			sess.editConfig(subtreeFilter);
		...
		public void test() throws Exception {
		    ...
		    Transport tr = new SSHSession(ssh);		  
		    NetconfSession sess= new NetconfSession( tr );
		    Element subtreeFilter = Element.create("http://tail-f.com/ns/simple/1.0","/storage");
		    print("Reading storage!");
		    Element reply = sess.get(subtreeFilter).first();
		    print("got "+ reply);;	
		    // create a few
		    reply = null;
		    Element storage = Element.create("http://tail-f.com/ns/simple/1.0","/storage[alias='kalle',type='foo']");
		    storage.markCreate();
		    if (!sess.getCapabilities().hasValidate())
			failed("session does not support the :validate capability");
		    print("validating config");
