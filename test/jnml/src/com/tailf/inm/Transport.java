 ...
 * This interface can be used to write
 * custom NETCONF transport mechanisms. The {@link NetconfSession}
 * constructor takes a transport mechanism to be responsible
 * for the actual sending and receiving of NETCONF protocol messages over
 * the wire. {@link SSHSession} and {@link TCPSession} implements
...
public interface Transport {
    ...
    /**
     * Prints an integer to the transport output stream and an
     * additional line break.
     */
    public void println(int i);

    /**
     * Prints a string to the transport output stream and an
     * additional line break.
     */
