...
public class SSHConnection {
    ...
    /**
     * By default we connect to the IANA registered port for NETCONF
     * which is 830
    ...
    /**
     * This method establishes an SSH connection to a host, once the
     * connection is established it must be authenticated.
     * @param host Host name.
     * @param port Port number to connect to.
     */
    public SSHConnection(String host, int port) throws IOException, INMException
 {
        this(host, port, 0);
 }
