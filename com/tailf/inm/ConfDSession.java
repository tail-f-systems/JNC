 ...
 * </pre>
 * <p>
 * The <code>:transactions</code> capability introduces four new rpc methods which are used to
 * control a two-phase commit transaction on the NETCONF server.  The
 * normal <code>edit-config</code> operation is used to write data in the
