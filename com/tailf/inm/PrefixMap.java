...
/**
 * This class implements a list of prefix mappings,
 * which provides mappings from namespaces to prefixes.
 *
 **/
public class PrefixMap extends ArrayList {
     ...
     * Prefix names that already exists will be unchanged.
     *
     */    
     ...
     * Replaces those that already exists,
     * and add the new ones that doesn't exist.
