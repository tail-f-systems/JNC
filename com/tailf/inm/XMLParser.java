...
public class XMLParser {
    ...
    /**
     * The handler with hooks for startElement etc.
     * The SAX parser will build up the parse tree,
	...
	public void startElement(String uri, String localName,
		...
		// System.out.println("ATTRIBUTE: "+attributes.getQName(i)+ "  URI="+attributes.getURI(i));
		trace("add attr: "+attr);
		child.addAttr(attr);
	    }
	    if (current==null) {
