...
public class RevisionInfo {
     ...
     * This requires that the .fxs file we used to generate the ConfM classes
     * has been produced by a "confdc --merge-revisions ... " command.
     * If this feature is enabled, we can safely talk NETCONF to devices
     * that have an older revision of the YANG data model than we have.
     * This means that we during the encode() process checks each
     * element and makes sure that the device understands it. If not, the
     * element is skipped.
     */
