...
/**
 * This class implements the "ipv6Prefix" datatype from
 * the 'http://tail-f.com/ns/confd/1.0' namespace.
 * <p>
 * The ipv6Prefix type represents an IPv6 address prefix. The prefix
 * length is given by the number following the slash character
 * and must be less than or equal 128.
 * <p>
 ...
 * <p>
 * The IPv6 address should have all bits that do not belong to the
 * prefix set to zero.
 * <p>
