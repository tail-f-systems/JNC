...
/**
 * This class implements the "confd:hexList" datatype from
 * the 'http://tail-f.com/ns/confd/1.0' namespace.
 *
 * Represents a list of colon separated hex octets.
 * For example:
 * 0F:B7  - is the encoding for the 16-bit integer 4023.
 *
 */
public class HexList implements Serializable {
    ...
    public HexList(java.lang.String v)
     ...
     */
    private byte[] intToBytes(long v)
        throws ConfMException {
        int i=0;
     ...
     */
    private byte[] parseValue(java.lang.String s)
        throws ConfMException {
    ...
    /**
     * xs:length defines an exact length measured in number of characters
     * or bytes.
     */
