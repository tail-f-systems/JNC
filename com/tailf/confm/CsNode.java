...
/**
 * The CsNode class is used to represent individual nodes in the
 * schema tree. Each generated ConfM namespace gets its schema,
 * as a set of CsNode objects generated in its top class
 * All the CsNode's for a namespace are put into hashtable that is held
 * by the CsTree class.
 */
...
public class CsNode {
    ...
    /*
     * Given an Element, find the CsNode, i.e. the schema class for
     * the data element
     */
