 ...
 * The type classes are used by the ConfM generated
 * classes.
 * <p>
 * This class is an encapsulation of all the classes in
 * the 'http://www.w3.org/2001/XMLSchema' namespace which
 * have been placed in the com.tailf.confm.xs package.
 *
 *
 */
public class Xs {
     ...
     *
     */
    static public class String extends com.tailf.confm.xs.String
     ...
     *
     */
    static public class NormalizedString extends com.tailf.confm.xs.NormalizedString
        implements Serializable {
     ...
     *
     */
    static public class Token extends com.tailf.confm.xs.Token
        implements Serializable {
     ...
     *
     */
    static public class Name extends com.tailf.confm.xs.Name
        implements Serializable {
     ...
     *
     */
    static public class NMTOKEN extends com.tailf.confm.xs.NMTOKEN
        implements Serializable {
     ...
     *
     */
    static public class NCName extends com.tailf.confm.xs.NCName
        implements Serializable {
     ...
     *
     */
    static public class ID extends com.tailf.confm.xs.ID
        implements Serializable {
     ...
     *
     */
    static public class Language extends com.tailf.confm.xs.Language
        implements Serializable {
     ...
     *
     */
    static public class Boolean extends com.tailf.confm.xs.Boolean
        implements Serializable {
     ...
     *
     */
    static public class Byte extends com.tailf.confm.xs.Byte
        implements Serializable {
     ...
     *
     */
    static public class Short extends com.tailf.confm.xs.Short
        implements Serializable {
     ...
     *
     */
    static public class Int extends com.tailf.confm.xs.Int
        implements Serializable {
     ...
     *
     */
    static public class Long extends com.tailf.confm.xs.Long
        implements Serializable {
     ...
     *
     */
    static public class Integer extends com.tailf.confm.xs.Integer
        implements Serializable {
     ...
     * Arbitrary big unsigned integer.
     * We do not support arbitrary big integers.
     * Represented with a 64-bit signed (long) integer.
     * (may not fit)
     */
     ...
     *
     */
    static public class Decimal extends com.tailf.confm.xs.Decimal
        implements Serializable {
     ...
     *
     */
    static public class Float extends com.tailf.confm.xs.Float
        implements Serializable {
     ...
     *
     */
    static public class Double extends com.tailf.confm.xs.Double
        implements Serializable {
     ...
     *
     */
    static public class PositiveInteger
        extends com.tailf.confm.xs.PositiveInteger
        implements Serializable {
     ...
     *
     */
    static public class NonPositiveInteger
        extends com.tailf.confm.xs.NonPositiveInteger
        implements Serializable {

        public NonPositiveInteger(java.lang.String value)
     ...
     *
     */
    static public class NegativeInteger
        extends com.tailf.confm.xs.NegativeInteger
        implements Serializable {
     ...
     *
     */
    static public class NonNegativeInteger
        extends com.tailf.confm.xs.NonNegativeInteger
        implements Serializable {

        public NonNegativeInteger(java.lang.String value)
            throws ConfMException {
            super(value);
        }
     ...
     *
     */
    static public class Duration extends com.tailf.confm.xs.Duration
        implements Serializable {
     ...
     *
     */
    static public class DateTime extends com.tailf.confm.xs.DateTime
        implements Serializable {
     ...
     *
     */
    static public class Date extends com.tailf.confm.xs.Date
        implements Serializable {
     ...
     *
     */
    static public class GYear extends com.tailf.confm.xs.GYear
        implements Serializable {
     ...
     *
     */
    static public class Time extends com.tailf.confm.xs.Time
        implements Serializable {
     ...
     *
     */
    static public class GMonth extends com.tailf.confm.xs.GMonth
        implements Serializable {
     ...
     *
     */
    static public class GDay extends com.tailf.confm.xs.GDay
        implements Serializable {
     ...
     *
     */
    static public class QName extends com.tailf.confm.xs.QName
        implements Serializable {
     ...
     *
     */
    static public class AnyURI extends com.tailf.confm.xs.AnyURI
        implements Serializable {
