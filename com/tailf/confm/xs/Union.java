...
/**
 * This class implements the "xs:union" datatype from
...
public abstract class Union implements Serializable {
    ...
    /**
     * Will try to construct from a string.
     * each union type at a time.
     */
    ...
    /**
     * Construct union containing the give object.
     * Must be one of the union types.
     */
    ...
    /**
     * Sets the union value to the given object.
     * Must be one of the union types.
     */
