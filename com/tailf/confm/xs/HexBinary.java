...
/**
 * This class implements the "xs:hexBinary" datatype from
 * the 'http://www.w3.org/2001/XMLSchema' namespace.
 *
 * Represents a list of octets.
 * For example:
 * 0FB7  - is the encoding for the 16-bit integer 4023.
 *
 */
public class HexBinary implements Serializable {
    ...
    public HexBinary(java.lang.String v)
    ...
    private byte[] parseValue(java.lang.String s)
        ...
        for (int i=0;i< r.length;i++) {
            r[i]= (byte) ( parseDigit(b[i*2],s)*0x10 +
                           parseDigit( b[i*2+1], s ));
