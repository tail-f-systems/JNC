...
import leafref.C;
import leafref.Leafref;
import leafref.Leafref2;
import leafref.c.L1;
...
public class Client {
    ...
    public static void main(String[] args) throws IOException, JNCException {
        ...
        ElementChildrenIterator lIterator = cConfig.l1Iterator();
        while (lIterator.hasNext()) {
            L1 h = (L1) lIterator.next();
            
            // Internal representations of key1 and key2
            YangString key1Value = h.getKey1Value();
            YangString key2Value = h.getKey2Value();
