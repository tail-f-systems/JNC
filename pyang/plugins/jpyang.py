...
class JavaClass(object):
    ...
    def java_class(self):
        ...
        date = get_date(date_format=0)

        # The header is placed in the beginning of the Java file
        header = '/* \n * @(#)' + self.filename + ' ' * 8 + self.version + ' ' + date + '''
 *
 ...
 */'''
        ...
        class_decl = 'public class ' + self.filename.split('.')[0] + self.modifiers + ' {\n'
        return header + class_decl + self.body + '\n}'
